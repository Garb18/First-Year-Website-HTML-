   ...
   <body>
      ...
      <section class="main-body">
         <section class="php-thanks">
            <h1>Mailing List Confirmation</h1>
            <!-- Three form elements, FirstName, LastName and Email -->
            <p>Thanks for joining <?php echo $_POST["FirstName"].$_POST["LastName"] ?> <br>
               Your email address <strong><?php echo $_POST["email"] ?></strong> has been saved in our mailing list.
            </p>
         </section>
      </section>
   </body>
